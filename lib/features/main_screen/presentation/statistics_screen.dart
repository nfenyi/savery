                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                AppText(
                                  text:
                                      '+${_periodFilter == 0 ? _overallIncome : _periodFilter == 1 ? _overallDayIncome : _periodFilter == 2 ? _overallWeekIncome : _periodFilter == 3 ? _overallMonthIncome : _overallYearIncome} GHc',
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                AppText(
                                  text:
                                      '-${_periodFilter == 0 ? _overallExpense : _periodFilter == 1 ? _overallDayExpense : _periodFilter == 2 ? _overallWeekExpense : _periodFilter == 3 ? _overallMonthExpense : _overallYearExpense} GHc',
                                  size: AppSizes.heading5,
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ListTile(
                              ...
                              title: (_periodFilter == 1)
                                  ? AppText(
                                      text:
                                          transaction.value[_descriptionString],
                                    )
                                  : AppText(
                              ...
                              trailing: AppText(
                                text:
                                    '${_inIncomeView ? '+' : '-'} GHc ${transaction.value[_amountString].toString()}',
                                size: AppSizes.body,
