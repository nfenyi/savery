...
// Stream<List<Goal>> goalStream({required String? selectedAccount}) {
//   final accountsBox = Hive.box<Account>(AppBoxes.accounts);
//   final goalsBox = Hive.box<Goal>(AppBoxes.goals);
//   late final StreamController<List<Goal>> controller;
//   late final StreamSubscription sub;
...
//   controller = StreamController<List<Goal>>.broadcast(
//     onListen: startStream,
//     onCancel: () {
//       sub.cancel;
//     },
